  ...
  <table width="100%" height="257" bgcolor="#FFFFFF">
    <tr valign="top">
      ...
      <td width="82%" height="24" align="left" valign="top"><p><font size="+3" color="#996600">Membership Request Display Form: </font><br />
        ...
        <p align="right"><font size="+1" color="#000099"><a href="adacc.jsp"><strong>|Back|</strong></a></font></p>
        <p align="center">
          <%
    Connection c;
    Statement s;
    ...
    try
     ...
     s=c.createStatement();
	 r=s.executeQuery("select *from MEMEBERSHIP");
	 out.println("<table>");
	 out.println("<tr>");
	 out.println("<th>");
	 ...
	 out.println("</th>");
     out.println("<th>");
	 out.println("Favriote Food");
	 out.println("</th>");
	 out.println("<th>");
	 out.println("Food Outside house");
	 out.println("</th>");
	 out.println("<th>");
